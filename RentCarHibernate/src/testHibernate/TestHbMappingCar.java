...
public class TestHbMappingCar {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    try {
      ...
      Date fromDate = sdf.parse("10.05.1992");
      Date toDate = sdf.parse("15.05.1992");
      ...
      System.out.println("LIST OF ALL CAR AFTER DELETE OF THE CAR WITH ID:\n" + newCarId + "\n");
      ...
      freeCars = Car.getFreeCars(hbSession, fromDate, toDate);
