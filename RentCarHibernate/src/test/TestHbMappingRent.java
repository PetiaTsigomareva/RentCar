...
public class TestHbMappingRent {
	...
	public static void main(String[] args) throws ParseException {
		...
		try {
			...
			car.store(hbSession);
			Renter renter = new Renter("Milen ", "Georgiew", "2356987415",
					"Sliven ul.Bulgarca23", "125639");
			...
			System.out
			.println("UPDATE CAR BEFORE STORE:" + rentToUpdate + "\n");
