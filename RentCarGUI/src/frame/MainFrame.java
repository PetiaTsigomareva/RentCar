...
public class MainFrame extends JFrame {
	...
	private JLabel getJLabelCar() {
		if (jLabelCar == null) {
			...
			jLabelCar.setText("  Налични автомобили :");
		}
		return jLabelCar;
	}
	...
	private JButton getJAddButton() {
		if (jAddButton == null) {
			...
			jAddButton.setText("Добави автомобил");
	...
	private JButton getJDeleteButton() {
		if (jDeleteButton == null) {
			...
			jDeleteButton.setText("Изтрий автомобил");
	...
	private void deleteCar() {
		...
		try {
			...
			showMessageDialog(this, "Настъпи проблем с изтриването на автомобила!\r\nМоля опитайте отново!", "Грешка", ERROR_MESSAGE);
